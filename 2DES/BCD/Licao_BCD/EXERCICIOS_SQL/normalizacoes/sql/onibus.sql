...
LOAD DATA INFILE 'D:\Licao_BCD\EXERCICIOS_SQL\normalizacoes\dados\motorista/motorista_onibus.CSV'
...
--importando telefone
LOAD DATA INFILE 'D:\Licao_BCD\EXERCICIOS_SQL\normalizacoes\dados\motorista/telefone_onibus.CSV'
INTO TABLE telefone
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
--importando dirige
LOAD DATA INFILE 'D:\Licao_BCD\EXERCICIOS_SQL\normalizacoes\dados\motorista/dirige_onibus.CSV'
INTO TABLE dirige
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
--importando linhas
LOAD DATA INFILE 'D:\Licao_BCD\EXERCICIOS_SQL\normalizacoes\dados\motorista/linhas_onibus.CSV'
INTO TABLE linha
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
